...
export const CATEGORY_MAINTENANCE_MAP: Record<string, MaintenanceType> = {
  ...
  A2_WALLS: 'building_element',
  A3_FLOORS: 'building_element',
  A4_CEILINGS: 'building_element',
  A5_FACADES: 'building_element',
  A6_WINDOWS: 'building_element',
  A7_DOORS: 'building_element',
  A8_STAIRS: 'building_element',
  A9_OTHER_STRUCTURE: 'building_element',
  A10_FOUNDATIONS: 'building_element',
  B1_HEATING: 'building_service',
  B2_COOLING: 'building_service',
  B3_VENTILATION: 'building_service',
  B4_DHW: 'building_service',
  B5_ELECTRICAL: 'building_service',
  B6_PLUMBING: 'building_service',
  C1_ELEVATORS: 'building_service',
  C2_FIRE_SAFETY: 'building_service',
  C3_OTHER_SERVICES: 'building_service',
  D1_SITE_WORKS: 'none',
  E1_OUTDOOR: 'none',
};
